...
Let **E** be a matrix containing the eigenvectors for the covariance matrix ($\hat\Sigma$) for our data. The eigenvectors in **E** are our principal components. As such, these are the requirements we need them to hold, the first a necessity and the second for convenience:
...
\centering
$\hat\Sigma$**E** $=$ **E**$\Lambda$ and $\hat\Sigma$ $=$ **E**$\Lambda E^T$

...
Using the eigenvalues, we can now determine which eigenvectors (components) we want to use or more importantly which ones to remove. A judgement call needs to be made. You will inevitably lose some information by culling components but if the eigenvalues are small, you won't lose much.   

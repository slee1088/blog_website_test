...
* We now train our dataset using the Naive Bayes classifier available in the *e1071* package. **Please ensure that the target labels (i.e. Yes/No) are set to a factor vector, otherwise the following code will generate an error.**
